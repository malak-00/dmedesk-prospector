...
**Before sharing the URL widely:** there's no authentication on this app
yet. Anyone with the link can search, generate AI briefs (spending your
Gemini/Foursquare quota), and export to your shared sheet. For an internal
tool, put it behind your host's built-in access controls, a VPN, or basic
auth until proper accounts are built.
